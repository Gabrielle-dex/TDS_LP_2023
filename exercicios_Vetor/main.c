...
/*   -----------------------------------------------------------------------     */
// %com alguma coisa significa que depois pode atribuir uma variavel
/* Para fazer referência ao eleento armazenado no vetor notas posição (índice) Zero.
 printf("vetor[0] = %d", vetor[0])
  mostrar o vetor 0 que tem o valor X, parametro do vetor mostrado pra poder mostrar no %d*/
/*PESQUISAR: 
    getch()? 
    return 0 com void?
    #include<conio.h>
